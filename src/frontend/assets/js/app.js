  ...
  var AppManager = {
    ...
    showLoading: function () {
      if (!$("#appLoadingOverlay").length) {
        $("body").append(
          '<div id="appLoadingOverlay" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.3);z-index:9999;display:flex;align-items:center;justify-content:center;"><div class="spinner-border text-light" role="status"></div></div>',
        );
      }
